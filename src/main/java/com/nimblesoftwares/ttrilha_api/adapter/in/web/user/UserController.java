...
public class UserController {
  ...
  @GetMapping(value = "/test-circuit")
  @CircuitBreaker(name = "test-circuit-breaker")
  public ResponseEntity<String> testCircuit() {
    throw new RuntimeException("Simulating circuit breaker failure");
  }
}
